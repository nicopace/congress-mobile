...
.factory('ConferenceData', function() {
  var data = {
    sessions: [
      { title: 'Experiencias de uso de Software Libre en Cooperativas', id: 1, time: '16:00', speaker: 1, description: 'Por qué tienen una relación privilegiada y cuáles son los puntos en común. Cómo se interrelacionan en la práctica diaria y cómo se potencian.'},
      { title: 'Impulsando el Software Libre en el Estado ', id: 2, time: '17:00', speaker: 2, description: 'Por qué el estado tiene que usar tecnologías libres. Cuáles son los beneficios que tiene aparejado este cambio de paradigma y cuáles son los costos.'},
